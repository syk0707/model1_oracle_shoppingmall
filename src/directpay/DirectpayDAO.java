...
public class DirectpayDAO {
	...
	public boolean delete(String email) {
		...
		sql.append(" DELETE FROM shoppingdirect");
	...
	public boolean readBasketemail(Map map) {
		...
		sql.append("  SELECT count(*) AS cnt FROM shoppingdirect   ");
		sql.append("  WHERE email = ? AND productname = ? ");
	...
	public BasketDTO readProductsum(String email) {
		...
		sql.append("  SELECT sum(productsum) AS sum FROM shoppingdirect   ");
		sql.append(" 	 WHERE email = ?  ");
	...
	public boolean create(Map map) {
		...
		sql.append(" INSERT INTO shoppingdirect (directID, email, productname, productaddress, ");
		sql.append(" 							 numbers, price,	productsum, uploadbtn) ");
		sql.append(" VALUES 					((SELECT NVL(MAX(directID),0) + 1 as directID FROM shoppingdirect), 		?,				?,			  ?, ");
		sql.append("		 					?,			?,			  ?, ?) ");
	...
	public BasketDTO read(String email) {
		...
		sql.append("  SELECT * FROM shoppingdirect  ");
		sql.append(" 	 WHERE email = ?  ");
